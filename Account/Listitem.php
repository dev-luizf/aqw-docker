...
<div id="page-container" class="full-width">
	<div id="fx-container" class="fx-opacity"><div id="page-content" class="block">
		...
		<div class="row gutter30">
			<div class="block full">
				...
				<form action="additem.php" method="POST">
					<div class="input-group">
						<input type="text" id="search-term" value="<?php echo addslashes($_POST['add-term']); ?>" name="add-term" class="form-control" placeholder="Item Name...">
			...
			<div class="block full">
				<div class="block-title">
					<h2><i class="fa fa-search"></i> Get Item</h2>
				</div>
		...
		<tr>
			...
			<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align="center"><b>Type</b></td>
			<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align="center"><b>File</b></td>
			<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align="center"><b>Stack</b></td>
		...
		<?php
			if(!(isset($_POST['search-term']))){
				...
				$sql = "SELECT * FROM `items` ORDER BY `id` ASC LIMIT ".$inicio.", ".$_BS['PorPagina'];
				$query = mysql_query($sql);
				...
				while ($resultado = mysql_fetch_assoc($query)) {
					...
					echo "
						<tr>
							...
							<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align='center'>$file</td>
							<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align='center'>$stack</td>
				...
				$busca_it = mysql_query("SELECT * FROM items WHERE ((`Name` LIKE '%".$busca_prot."%') OR ('%".$busca_prot."%'))");
