...
<div id="page-container" class="full-width">
	<div id="fx-container" class="fx-opacity"><div id="page-content" class="block">
		...
		<ul class="breadcrumb breadcrumb-top">
			...
			<li>Get Shop: <?php echo $_POST['search-term']; ?></li>
		</ul>
		...
		<div class="row gutter30">
			...
			<div class="block full">
				<div class="block-title">
					<h2><i class="fa fa-search"></i> Get Shop</h2>
				</div>
		...
		<?php
			if(!(isset($_POST['search-term']))){
				...
				$sql = "SELECT * FROM `shops` ORDER BY `id` ASC LIMIT ".$inicio.", ".$_BS['PorPagina'];
				$query = mysql_query($sql);
				...
				$busca_it = mysql_query("SELECT * FROM shops WHERE ((`Name` LIKE '%".$busca_prot."%') OR ('%".$busca_prot."%'))");
				...
				echo "</table>
				<center><a href='Listshop.php'><br /><br />Complete list of Shops</a></center>
				";
			}
		?>
