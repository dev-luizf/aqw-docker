	...
	<body>
		<div id="tudo">
			...
			<div id="conteudo" class="shadow">
				...
				<p><center>Only Staff have access to the Panel of Rules</center></p>
...
<div id="page-container" class="full-width">
	<div id="fx-container" class="fx-opacity"><div id="page-content" class="block">
		...
		<ul class="breadcrumb breadcrumb-top">
			...
			<li>Painel de Logs</li>
		</ul>
		
		<div class="row gutter30">
		<li>
            <h3 class="normal">Eventos</h3>
                <p>Moderadores só poderão adicionar eventos com a autorização do Administrador se algum Moderador adicionar um evento que não tenha sido permitido por um Administrador esse Moderador será retirado da Staff e terá sua conta banida.</p>
        </li>
		<br>
		<li>
            <h3 class="normal">Items</h3>
                <p>Moderadores podem adicionar items a qualquer hora porem somente em um shop privado não é permitidor que os Moderadores adicionem items em shops ja existentes no game como os shops de Faroff por exemplo porem o Moderador poderá adicionar items em um shop que ele mesmo criar ou então quando ele fizer um evento e quiser dar um Upgrade no shop do evento dele alem disso um Moderador não pode interferir no evento de outro Moderador apenas se tiver permissão bom caso descumpra essas regras você será retirado da Staff e terá sua conta banida.</p>
        </li>
		<br>
		<li>
            <h3 class="normal">Edição</h3>
                <p>Moderadores não podem mexer em items,shops,monsters,mapas,classes,enhancements e quests ja adicionados no jogo a não ser que seja uma coisa que ele mesmo adicionou ai ele terá total liberdade para edita-lo depois de adicionado caso não goste do preço ou queira mudar algo.</p>
        </li>
		<br>
		<li>
            <h3 class="normal">Upload</h3>
                <p>Quando você for fazer o Upload de um arquivo para a VPS lembre-se de 2 coisa primeiro o arquivo tem que ser obrigatoriamente um swf não tem como enviar arquivos em html e segundo caso você tente enviar um arquivo e apareça algum erro significa que este arquivo ja existe dentro das files.</p>
        </li>
		<br>
			<br /><br /><br />
		</div>
	...
	<footer class="clearfix">
		...
		<div class="pull-left">
			<span>2014 - 2016</span> © <a href="/" target="_blank">ArmgedomWorlds</a>
		</div>
	</footer>
	</div>
</div>
