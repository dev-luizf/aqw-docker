...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if($lastpage > 1)
		{   
		    $pagination .= "<ul class='pagination color'>";
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext' class='prev'>Previous</a></li>";
		else
		    $pagination.= "<li><a href='#' class='prev'>Previous</a></li>";
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext' class='next'>Next</a></li>";
		else
		    $pagination.= "<li><a href='#' class='next'>Next</a></li>";
		    $pagination.= "</ul>\n";       
		}
