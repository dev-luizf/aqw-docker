<?php /* Smarty version Smarty-3.1.16, created on 2014-06-13 09:20:25
         compiled from "templates\playnow\template.default.html" */ ?>
<?php /*%%SmartyHeaderCode:107285388cb1248e444-44848773%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '107285388cb1248e444-44848773',
  'function' => 
  array (
  ),
  'cache_lifetime' => 120,
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5388cb12546ba2_38545690',
  'variables' => 
  array (
    'Description' => 0,
    'Title' => 0,
...
<?php if ($_valid && !is_callable('content_5388cb12546ba2_38545690')) {function content_5388cb12546ba2_38545690($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\inetpub\\wwwroot\\AUGOEIDES.ORG\\classes\\class.smarty\\plugins\\modifier.date_format.php';
...
$(function() {
  ...
  if (!<?php echo '/*%%SmartyNocache:107285388cb1248e444-44848773%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->Login;?>
/*/%%SmartyNocache:107285388cb1248e444-44848773%%*/';?>
) {
    $("#dynamenu_wrapper").hide();
      ...
      if (document.URL.indexOf("register") < 0) {
          if (<?php echo '/*%%SmartyNocache:107285388cb1248e444-44848773%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->ActivationFlag;?>
/*/%%SmartyNocache:107285388cb1248e444-44848773%%*/';?>
 < 5) { $("#email").fadeIn(1000); }
          if (<?php echo '/*%%SmartyNocache:107285388cb1248e444-44848773%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->Access;?>
/*/%%SmartyNocache:107285388cb1248e444-44848773%%*/';?>
...
account" id="tabcon_tab5" target="_blank">Settings</a>
        <a href="<?php echo $_smarty_tpl->tpl_vars['Root']->value;?>
?profile=<?php echo '/*%%SmartyNocache:107285388cb1248e444-44848773%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->Name;?>
/*/%%SmartyNocache:107285388cb1248e444-44848773%%*/';?>
...
wiki" target="_blank">HP Wiki</a>
        | <a href="http://forum.augoeides.org" target="_blank">Forum</a>
