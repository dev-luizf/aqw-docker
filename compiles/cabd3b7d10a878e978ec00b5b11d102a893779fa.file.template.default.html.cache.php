<?php /* Smarty version Smarty-3.1.19, created on 2014-11-06 00:14:34
         compiled from "templates\playnow\template.default.html" */ ?>
<?php /*%%SmartyHeaderCode:14049545b2deac6fc84-26514703%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cabd3b7d10a878e978ec00b5b11d102a893779fa' => 
    array (
  ...
  'nocache_hash' => '14049545b2deac6fc84-26514703',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_545b2dead6fd22_64797289',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545b2dead6fd22_64797289')) {function content_545b2dead6fd22_64797289($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\UniServerZ\\www\\classes\\class.smarty\\plugins\\modifier.date_format.php';
?>
...
$(function() {
  ...
  if (!<?php echo '/*%%SmartyNocache:14049545b2deac6fc84-26514703%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->Login;?>
/*/%%SmartyNocache:14049545b2deac6fc84-26514703%%*/';?>
) {
    $("#dynamenu_wrapper").hide();
      ...
      if (document.URL.indexOf("register") < 0) {
          if (<?php echo '/*%%SmartyNocache:14049545b2deac6fc84-26514703%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->ActivationFlag;?>
/*/%%SmartyNocache:14049545b2deac6fc84-26514703%%*/';?>
 < 5) { $("#email").fadeIn(1000); }
          if (<?php echo '/*%%SmartyNocache:14049545b2deac6fc84-26514703%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->Access;?>
/*/%%SmartyNocache:14049545b2deac6fc84-26514703%%*/';?>
...
account" id="tabcon_tab5" target="_blank">Settings</a>
        <a href="<?php echo $_smarty_tpl->tpl_vars['Root']->value;?>
?profile=<?php echo '/*%%SmartyNocache:14049545b2deac6fc84-26514703%%*/<?php echo $_smarty_tpl->tpl_vars[\'UserData\']->value->Name;?>
/*/%%SmartyNocache:14049545b2deac6fc84-26514703%%*/';?>
...
gamefiles/gameloader_R9.swf" width="960" height="550" loop="false" 
