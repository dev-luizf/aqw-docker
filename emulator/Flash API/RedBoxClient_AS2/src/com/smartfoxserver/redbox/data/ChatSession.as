 ...
 */
class com.smartfoxserver.redbox.data.ChatSession
{
	/**
	 ...
	 * @see	#status
	 */
	public static var STATUS_ACCEPTED:String = "accepted"
	 ...
	 * @see	#status
	 */
	public static var STATUS_ACTIVE:String = "active"
	 ...
	 * Accessing the user's outgoing stream can be useful to pause/resume the live stream. Pausing and resuming the live stream can be achieved using the <b>NetStream.attachVideo</b> method, passing {@code null} to pause and {@code Camera.get()} to resume.
	 ...
	 */
	public function get mateId():Number
	{
		return _mateId
	}
