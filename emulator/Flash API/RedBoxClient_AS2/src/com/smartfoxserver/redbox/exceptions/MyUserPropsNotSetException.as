 ...
 */
class com.smartfoxserver.redbox.exceptions.MyUserPropsNotSetException extends Error
{
	/**
	...
	{
		super("SmartFoxClient.myUserId and/or SmartFoxClient.myUserName properties not set: in case of custom login they must be set manually to the actual server values")
	}
}